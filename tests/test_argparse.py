...
def test_boolean_overrides_explicit(empty_object_yaml_input: YamlInput):
    o = OptionalBooleansHparam.create(cli_args=['-f', empty_object_yaml_input.filename,'--default_true', 'false', '--default_false', 'true'])
...
def test_boolean_overrides_implicit(empty_object_yaml_input: YamlInput):
    o = OptionalBooleansHparam.create(cli_args=['-f', empty_object_yaml_input.filename, '--default_true', '--default_false'])
